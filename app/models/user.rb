class User < ApplicationRecord
  ...
  validates :password, presence: true, length: { minimum: Settings.user_validates.max_lenght_password}, allow_nil: true
  ...
  def password_reset_expired?
    reset_sent_at < Settings.time_expiration.hours.ago
  end
